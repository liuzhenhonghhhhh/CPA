...
// Backfiller is an optional interface that a Store can implement to support
// on-demand loading of additional auth entries from a standby pool.
type Backfiller interface {
	Backfill(ctx context.Context, count int) ([]*Auth, error)
}
